...
import {
  getAllTestsCollected,
  saveLabTests,
  sampleTaken
} from "../../actions/appointmentActions";

class PublishResults extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      testsample: [],
  ...
  componentDidMount() {
    if (this.props.auth.isAuthenticated) {
      this.props.getAllTestsCollected();
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.appointment) {
      this.setState({
        testsample: nextProps.appointment.testscollected
      });
    } else {
      this.setState({
        testsample: []
...
PublishResults.propTypes = {
  getAllTestsCollected: PropTypes.func.isRequired,
