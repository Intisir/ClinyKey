...
import SendToTest from "./components/pages/SendToTest";
...
import SampleCollection from "./components/pages/SampleCollection";
import PublishResults from "./components/pages/PublishResults";
          ...
          <div className="container-fluid">
            <div className="row">
              ...
              <main className="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
                ...
                <Route exact path="/sendtest/:presid" component={SendToTest} />
                <Route exact path="/addresult/:resid" component={AddResult} />
                <Route
                  exact
