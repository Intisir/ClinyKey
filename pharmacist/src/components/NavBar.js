...
class NavBar extends Component {
  ...
  onVoice() {
    ...
    try {
      ...
      recognition.onresult = function(event) {
        ...
        if (path === "/") {
          state.props.getPrescriptions(state.state.search);
        }
      };
  ...
  onSearch(e) {
    ...
    let path = this.props.location.pathname;
    if (path === "/") {
      this.props.getPrescriptions(this.state.search);
    }
  }
...
NavBar.propTypes = {
  ...
  getPrescriptions: PropTypes.object.isRequired
};
...
export default connect(
  mapStateToProps,
  { OpenNav, loginUser, logoutUser, getProfilesBySearch, getPrescriptions }
)(withRouter(NavBar));
